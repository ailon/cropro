    ...
    public rasterize(
        ...
        return new Promise<string>((resolve) => {
            ...
            imageCopy.setAttribute(
              'height',
              cropImage.height.baseVal.valueAsString
            );
            imageCopy.setAttribute(
              'viewBox',
              '0 0 ' +
            ...
            if (this.naturalSize === true) {
                ...
                xScale = original.naturalWidth / (cropImage.width.baseVal.value - margin * 2);
                yScale = original.naturalHeight / (cropImage.height.baseVal.value - margin * 2);
                imageCopy.width.baseVal.value = original.naturalWidth + margin * xScale * 2;
                imageCopy.height.baseVal.value = original.naturalHeight + margin * yScale * 2;
